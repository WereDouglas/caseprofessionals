    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                <a href="#" class="brand">
                    <img  height="70px" width="120px" class="nav" src="<?= base_url(); ?>images/banner.png" alt="Logo" />
...
<!--                    <li class="green">
  ...
  <?php require_once(APPPATH . 'views/side-page.php'); ?>
...
<script language="javascript" type="text/javascript">
  function resizeIframe(obj) {
    obj.style.height = obj.contentWindow.document.body.scrollHeight + 'px';
            ...
            <div class="row-fluid ">
                <iframe id="frame" name="frame" frameborder="no" border="0" onload="resizeIframe(this)" scrolling="no"  style="padding: 10px;" width="450" class="span12" src="<?php echo base_url() . "index.php/schedule"; ?>"> </iframe>         
            </div><!--/.row-fluid-->
...
<![endif]-->
    ...
    <script src="<?= base_url(); ?><?= base_url(); ?>assets/js/bootstrap.min.js"></script>
