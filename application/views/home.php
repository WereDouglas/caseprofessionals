...
<body>
  ...
  <?php require_once(APPPATH . 'views/side-page.php'); ?>
        <div class="main-content">         
            ...
            <div class="row-fluid">
                <iframe id="frame" name="frame" frameborder="no" border="0" scrolling="no" height="750"  style="padding: 10px;" width="450" class="span12" src="<?php echo base_url() . "index.php/welcome/page"; ?>"> </iframe>         
            </div><!--/.row-fluid-->
